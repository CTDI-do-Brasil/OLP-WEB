...
^FO37,171^GFA,228,464,8,:Z64::F631^FS
^FO285,290^BQN,2,5
^FH\\^FDLA,${qrData}^FS
^PQ1,0,1,Y
^XZ`;
  ...
  // Padrão 300 DPI (Layout Exato Solicitado)
  return `CT~~CD,~CC^~CT~
^XA
~TA000
~JSN
...
^FT49,351^A0B,25,25^FH\\^CI28^FD${dateStr}^FS^CI27
^FT178,343^A0B,25,25^FH\\^CI28^FD${timeStr}^FS^CI27
^FO0,353^GB1216,0,9^FS
^FO194,230^GB0,128,9^FS
